...
var hoverEffect = function(opts) {
    ...
    var tweenTo = function(target, duration, vars) {
        ...
        } else if (typeof TweenMax !== "undefined" && TweenMax.to) {
    ...
    var addEvents = function(){
        ...
        parent.addEventListener(evtIn, function(e) {
            tweenTo(mat.uniforms.dispFactor, speedIn, {
                value: 1,
                ease: easing
            });
        });
        ...
        parent.addEventListener(evtOut, function(e) {
            tweenTo(mat.uniforms.dispFactor, speedOut, {
                value: 0,
                ease: easing
            });
        });
