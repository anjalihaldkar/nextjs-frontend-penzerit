                                      ...
                                      <div className="widget-box service-download-box mt-4">
                                          ...
                                          <div className="service-download-btn mb-10">
                                              <Link href="https://panzerit.com/brands/" target="_blank" className="theme-btn btn-style-1 d-grid">
                                                  <span className="btn-title"><Image className="mr-10" src="/assets/images/service/service-details-icon01.webp" alt="" width={18} height={24} sizes="100vw" style={{ width: "100%", height: "auto" }} />PIT_Presentation.pptx</span>
                                              </Link>
                                          </div>
                                          <div className="service-download-btn">
                                              <Link href="/contact" className="theme-btn btn-style-2 d-grid bg-dark">
                                                  <span className="btn-title"><Image className="mr-10" src="/assets/images/service/service-details-icon02.webp" alt="" width={22} height={24} sizes="100vw" style={{ width: "100%", height: "auto" }} />Request Brand Consultation</span>
                                              </Link>
                                          </div>
                                      </div>
                                  </div>
                          ...
                          <div className="col-xl-8 col-lg-8">
                              <div className="services-details__content">
                                  <div className="image overlay-anim1">
                                      <Image className="br-10 w-100" src="/assets/images/about/cyber.webp" alt="Panzer IT security brands" width={612} height={408} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                  </div>
                                      ...
                                      <div className="col-lg-6 col-md-6 col-sm-6">
                                          <div className="featured-list">
                                              <ul className="list-style-1">
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> IAM, PAM, PSM and DBAM</li>
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> Employee monitoring and UBA</li>
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> Endpoint DLP and insider threat visibility</li>
                                              </ul>
                                          </div>
                                      </div>
                                      <div className="col-lg-6 col-md-6 col-sm-6">
                                          <div className="featured-list">
                                              <ul className="list-style-1">
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> VAPT and vulnerability management</li>
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> Secure remote access and control</li>
                                                  <li><span><Image src="/assets/images/service/details-check.webp" alt="" width={16} height={14} sizes="100vw" style={{ width: "100%", height: "auto" }} /></span> Anti-malware, backup and disaster recovery</li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>                            
                                  <div className="row gy-30 align-items-stretch">
                                      <div className="col-lg-4 col-md-6" id="netand">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/01.png" alt="Netand IAM PAM" className="mb-20 panzer-brand-detail-logo" width={190} height={40} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="mirobase">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/02.png" alt="Mirobase Employee Monitoring" className="mb-20 panzer-brand-detail-logo" width={300} height={81} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="falcongaze">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/03.webp" alt="FalconGaze SecureTower" className="mb-20 panzer-brand-detail-logo" width={258} height={45} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="somansa">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/04.webp" alt="Somansa Endpoint DLP" className="mb-20 panzer-brand-detail-logo" width={300} height={63} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="secpoint">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/05.png" alt="SecPoint Penetrator" className="mb-20 panzer-brand-detail-logo" width={200} height={35} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="netop">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/06.png" alt="Netop Secure Remote Access" className="mb-20 panzer-brand-detail-logo" width={159} height={104} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="emsisoft">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/07.png" alt="Emsisoft Anti-Malware" className="mb-20 panzer-brand-detail-logo" width={301} height={89} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="vembu">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/08.png" alt="Vembu BDR Suite" className="mb-20 panzer-brand-detail-logo" width={300} height={64} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                                      ...
                                      <div className="col-lg-4 col-md-6" id="acronis">
                                          <div className="service-details-block h-100">
                                              <div className="inner-box d-block">
                                                  <Image src="/assets/images/brands/09.png" alt="Acronis Backup Solution" className="mb-20 panzer-brand-detail-logo" width={190} height={36} sizes="100vw" style={{ width: "100%", height: "auto" }} />
